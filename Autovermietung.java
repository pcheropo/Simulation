...
public class Autovermietung extends Model {
    ...
    */
    public double getBedienZeit() {//wichtig für vermietstation
    ...
    */
    protected Queue<KundeEntity> vermietstation;
    protected Queue<KundeEntity> terminal1;
    protected Queue<KundeEntity> terminal2;
	...
	*/
     ...
     * Konstruktor
    */
    public Autovermietung(Model owner, String name, boolean showInReport, 
                            boolean showIntrace) {
    ...
    * Initialisierung der benutzten DESMO-J Infrastruktur
    ...
    public void init() {
    	...
    	// Par 6: show in trace?
        bedienZeit = 
            new ContDistUniform(this, "Bedienzeiten", 2.0, 5.0, true, true);	
    	...
    	// Par 4: show in trace?
       	vermietstation = new Queue<KundeEntity>(this, "Kunden-Warteschlange",true, true);	
       	terminal1 = new Queue<KundeEntity>(this, "Kunden-Warteschlange",true, true);
       	terminal2 = new Queue<KundeEntity>(this, "Kunden-Warteschlange",true, true);
    	...
    	// Par 3: show in trace?
    	for (int i = 1; i<=1; i++){
    	schalter = new SchalterEntity(this, "Vermietstation", true);
        // Schalter einfuegen
    ...
    public static void main(java.lang.String[] args) {
        ...
        Autovermietung sch_e_model = 
            new Autovermietung(null, "Schalter Modell", true, true);  
